...
os.makedirs('Sorted_lists_GALEX_FUV', exist_ok=True)
...
def zero():
    ...
    os.makedirs('Sorted_lists_GALEX_FUV/msrb',exist_ok=True)
    df.round({'RA': 7, 'DEC': 7, 'MSRB': 7, 'Reff': 7, 'MAG_R': 7, 'SERSI': 7}).to_csv('Sorted_lists_GALEX_FUV/msrb/sorted_msrb_catg.csv',index = False)
'''
def one():
    df = pd.read_csv('catalogue.csv', sep=',', skipinitialspace=True )
    column_order = ['KIDSFIELD', 'SEXID', 'RA', 'DEC', 'MSRB', 'Reff', 'MAG_R', 'SERSI']
    ...
    os.makedirs('Sorted_lists_GALEX_FUV/reff',exist_ok=True)
    df[column_order].to_csv('Sorted_lists_GALEX_FUV/reff/sorted_reff_catg.csv',index = False)
...
def two():
    ...
    os.makedirs('Sorted_lists_GALEX_FUV/magtot',exist_ok=True)
    df[column_order].to_csv('Sorted_lists_GALEX_FUV/magtot/sorted_magtot_catg.csv',index = False)
'''
...
def three():
    ...
    os.makedirs('Sorted_lists_GALEX_FUV/seri',exist_ok=True)
    df.round({'RA': 7, 'DEC': 7, 'MSRB': 7, 'Reff': 7, 'MAG_R': 7, 'SERSI': 7}).to_csv('Sorted_lists_GALEX_FUV/seri/sorted_seri_catg.csv',index = False)

loopcycle=False
os.chdir('/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/')
...
while loopcycle==False:
        ...
        if inpval==0:
            ...
            zero()
            loopcycle=True
            os.chdir('/home/soumyananda/Dropbox/Goswami_REVISED/CATALOGRADEC_SPLICED/Sorted_lists_GALEX_FUV/msrb/')
            ...
            #print(val)
            os.makedirs('/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_MSRB/',exist_ok=True)
            os.chdir("/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_MSRB/")
            f=open("countsinfogalexfuv.txt","w+")
            ...
            for i in range(1,10):
                ...
                for k in range(1, n):
                    ...
                    for h in range(0,len(file_list)):
                        ...
                        if np.isclose(btemp1, s1, rtol=1e-4, atol=1e-5, equal_nan=False) and np.isclose(ctemp1, s2, rtol=1e-4, atol=1e-5, equal_nan=False):
                            #print(btemp1-s1)
                            #print(ctemp1-s2)
                            temp = "/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/" + z + "/"
                            shutil.copy2(str(pt), temp)
                image_concat = []
                temp1 = "/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/" + z + "/"
                os.chdir(temp1)
                ...
                for counter in range(0, 10):
                    ...
                    s111 = "stack_galexfuv6as_temp"+ str(counter) + ".fits"
                    os.makedirs(
                        '/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_MSRB/',
                        exist_ok=True)
                    os.chdir(
                        "/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_MSRB/")
                ...
                s11 = "stack_galexfuv6as_" + str(i) + ".fits"
                s12 = "stack_galexfuv6as_" + str(i) + ".png"
                os.chdir("/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_MSRB/")
                shutil.rmtree(temp1)
        ...
        if inpval==0:
            ...
            three()
            loopcycle=True
            os.chdir('/home/soumyananda/Dropbox/Goswami_REVISED/CATALOGRADEC_SPLICED/Sorted_lists_GALEX_FUV/seri/')
            ...
            val = (num_end - num_start) / 12
            #print(val)
            os.makedirs('/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_SERI/',exist_ok=True)
            os.chdir("/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_SERI/")
            f=open("countsinfogalexfuv1.txt","w+")
            f.write("x,y,yerr,num_files\n")
            os.chdir('/home/soumyananda/Dropbox/Goswami_REVISED/CATALOGRADEC_SPLICED/Sorted_lists_GALEX_FUV/seri/')
            for i in range(1,10):
                resl=num_start + val*(i-1) #incremental dynamic setting for splitting files
                ...
                for counter in range(0, 10):
                    ...
                    s111 = "stack_galexfuv6as_temp"+ str(counter) + ".fits"
                    os.makedirs(
                        '/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_SERI/',
                        exist_ok=True)
                    os.chdir(
                        "/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES_SERI/")
                    hdu1.writeto(s111, overwrite=True)
